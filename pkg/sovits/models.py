...
import plugins.chat_voice.pkg.sovits.modules.attentions as attentions
import plugins.chat_voice.pkg.sovits.modules.commons as commons
import plugins.chat_voice.pkg.sovits.modules.modules as modules
import plugins.chat_voice.pkg.sovits.utils as utils
from plugins.chat_voice.pkg.sovits.modules.commons import get_padding
from plugins.chat_voice.pkg.sovits.utils import f0_to_coarse
...
class SynthesizerTrn(nn.Module):
    ...
    def __init__(self,
        ...
        if vocoder_name == "nsf-hifigan":
            from plugins.chat_voice.pkg.sovits.vdecoder.hifigan.models import Generator
            self.dec = Generator(h=hps)
        elif vocoder_name == "nsf-snake-hifigan":
            from plugins.chat_voice.pkg.sovits.vdecoder.hifiganwithsnake.models import Generator
            self.dec = Generator(h=hps)
        else:
