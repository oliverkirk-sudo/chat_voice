...
from plugins.chat_voice.pkg.sovits.vencoder.hubert import hubert_model


class HubertSoft(SpeechEncoder):
    def __init__(self, vec_path=os.path.join(os.getcwd(), "plugins/chat_voice/pkg/sovits/pretrain/hubert-soft-0d54a1f4.pt"), device=None):
        super().__init__()
