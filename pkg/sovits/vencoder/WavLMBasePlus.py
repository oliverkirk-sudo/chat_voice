...
from plugins.chat_voice.pkg.sovits.vencoder.wavlm.WavLM import WavLM, WavLMConfig


class WavLMBasePlus(SpeechEncoder):
    def __init__(self, vec_path=os.path.join(os.getcwd(), "plugins/chat_voice/pkg/sovits/pretrain/WavLM-Base+.pt"), device=None):
        super().__init__()
