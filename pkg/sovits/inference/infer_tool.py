...
import plugins.chat_voice.pkg.sovits.cluster as cluster
from plugins.chat_voice.pkg.sovits.diffusion.unit2mel import load_model_vocoder
from plugins.chat_voice.pkg.sovits.inference import slicer
from plugins.chat_voice.pkg.sovits.models import SynthesizerTrn
...
class Svc(object):
    def __init__(self, net_g_path, config_path,
        ...
        if self.nsf_hifigan_enhance:
            from plugins.chat_voice.pkg.sovits.modules.enhancer import Enhancer
            self.enhancer = Enhancer('nsf-hifigan', os.path.join(os.getcwd(), "plugins/chat_voice/pkg/sovits/pretrain/nsf_hifigan/model"), device=self.dev)
