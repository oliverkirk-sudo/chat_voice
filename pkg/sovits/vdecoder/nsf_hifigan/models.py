...
#    h = load_config(os.path.join(os.getcwd(), "plugins/chat_voice/pkg/sovits/pretrain/nsf_hifigan/model"))
...
#    config_file = os.path.join(os.getcwd(), "plugins/chat_voice/pkg/sovits/pretrain/nsf_hifigan/config.json")
